...
public class DbAdapter
{
	...
	private static final int DATABASE_VERSION = 2;
		...
		private static final String DATABASE_TABLE_TRIPPLANNER = "tripplanner";
	
//		private static final String DATABASE_TRIPPLANNER_CREATE = "create table if not exists tripplanner (_id integer primary key autoincrement,"
